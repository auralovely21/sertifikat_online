                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center"><label class="btn btn-primary btn-sm" style="margin-right: 3px;"><a class="text-light" style="text-decoration: none;" href="<?= base_url('admin/sertifikat/edit/' . $certificate->certificate_id) ?>">Edit</a></label><label class="btn btn-danger btn-sm" style="margin-left: 3px;"><a class="text-light" style="text-decoration: none;" href="<?= base_url('admin/sertifikat/hapus/' . $certificate->certificate_id) ?>">Delete</a></label></td>
                          </tr>
                        <?php
                        }
                        ?>
