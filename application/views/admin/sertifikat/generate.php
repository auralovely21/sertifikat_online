                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <label class="btn btn-secondary btn-sm" style="margin-right: 3px;"><a class="text-light" style="text-decoration: none;" href="<?= base_url('admin/generate/download/' . $generate->assignment_id) ?>">Download</a></label><!-- <label class="badge badge-info" style="margin: 3px;"><a class="text-info" style="text-decoration: none;" href="<?= base_url('edit_generate/' . $generate->assignment_id) ?>">Edit</a></label> --><label class="btn btn-danger btn-sm" style="margin-left: 3px;"><a class="text-light " style="text-decoration: none;" href="<?= base_url('admin/generate/fungsi_hapus/' . $generate->assignment_id) ?>">Delete</a></label>
                            </td>
                          </tr>
                        <?php
                        }
