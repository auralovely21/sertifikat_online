    ...
    <div class="sidebar pe-4 pb-3">
      <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
          ...
          <a href="../admin/dashboard_admin" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Events</a>
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Sertifikat</a>
            <div class="dropdown-menu bg-transparent border-0">
              <a href="../admin/sertifikat" class="dropdown-item">Sertifikat</a>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center"><label class="btn btn-primary btn-sm" style="margin-right: 3px;"><a class="text-light" style="text-decoration: none" href="<?= base_url('admin/event/edit/' . $event->event_id) ?>">Edit</a>
                        </label><label class="btn btn-danger btn-sm" style="margin-left: 3px"><a class="text-light" style="text-decoration: none;" href="<?= base_url('admin/event/fungsi_hapus/' . $event->event_id) ?>">Delete</a></label></td> 
                        </tr>
                        <?php
                        }
                        ?>
